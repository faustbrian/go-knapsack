...
test -s verification/references.tsv
test -s verification/corpora.tsv
awk -F '\t' 'NR == 1 {next} NF != 6 || $1 == "" || $2 == "" || $3 == "" || $4 == "" || $5 == "" || $6 == "" {exit 1}' verification/references.tsv
awk -F '\t' 'NR == 1 {next} NF != 5 || $1 == "" || $2 == "" || $3 == "" || $4 == "" || $5 == "" {exit 1}' verification/corpora.tsv
...
grep -q 'Apache-2.0' verification/corpora.tsv
...
if grep -q 'terms-not-stated' verification/corpora.tsv; then
